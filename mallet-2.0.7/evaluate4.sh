...
i=18
	...
	sh bin/mallet evaluate-topics --evaluator noticias-evaluator.$i.$y.evaluator --input noticias_test.mallet --output-doc-probs noticias-doc-probs.$i.$y.txt --output-prob noticias_prob.$i.$y.txt
